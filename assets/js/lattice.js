...
class Lattice {
    constructor(selector) {
        ...
        // Adjust number of BECs to fit on canvas
        ...
        window.requestAnimationFrame(Lattice.draw_callback(this, size, lineWidth));
    }
        ...
        return function () {
            ...
            if (!lattice.stop) {
                window.requestAnimationFrame(
                    Lattice.draw_callback(lattice, size, lineWidth)
                );
            }
        }
    }
